...
# Average CV score on the training set was:-0.0037697600602864764
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=LinearSVR(C=0.001, dual=True, epsilon=0.001, loss="epsilon_insensitive", tol=0.001)),
