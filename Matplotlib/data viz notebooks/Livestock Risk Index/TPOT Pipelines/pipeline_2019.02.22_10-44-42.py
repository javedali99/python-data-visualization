...
# Average CV score on the training set was:-0.0030656271810116354
exported_pipeline = make_pipeline(
    ...
    RandomForestRegressor(bootstrap=False, max_features=0.45, min_samples_leaf=2, min_samples_split=14, n_estimators=100)
)
